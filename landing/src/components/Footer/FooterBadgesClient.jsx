        ...
        <Link href={socials.twitter} target="_blank" rel="noopener noreferrer">
          ...
          >
            ...
            <motion.span 
              ...
              transition={{ duration: 0.5, repeat: isHeartHovered ? Infinity : 0 }}
            >
              <svg 
                className={`w-5 h-5 ${isHeartHovered ? 'text-red-500' : 'text-white/60'}`} 
                viewBox="0 0 24 24" 
            ...
            <span className="underline text-white ml-1 hover:text-primary transition-colors"> this guy</span>
          </motion.p>
        </Link>
      </div>
    </div>
